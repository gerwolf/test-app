...
# Map_legen + Borough_checklist + Recycling_type_checklist + Web_link + Map
    html.Div([
       html.Div([
            ...
            # Borough_checklist
            html.Label(children=['Place: '], style=blackbold),
            dcc.Dropdown(id='search-word',
                    options=[{'label': i, 'value': i} for i in all_df['Place Name'].unique()],
...
@app.callback(Output('graph', 'figure'),
              [Input('search-word', 'value'), Input('recycling_type', 'value')])

def update_figure(search_word, chosen_recycling):
    ...
    locations=[go.Scattermapbox(
                    ...
                    text = sub_df['Place Name'] + "<br>" + "Cluster ID: " + str(df_sub['Cluster Label'])
